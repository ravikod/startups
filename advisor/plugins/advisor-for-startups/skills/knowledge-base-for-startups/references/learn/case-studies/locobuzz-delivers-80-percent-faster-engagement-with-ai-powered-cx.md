---
source_url: https://aws.amazon.com/startups/learn/locobuzz-delivers-80-percent-faster-engagement-with-ai-powered-cx
...
Key AWS services underpin this transformation. [Amazon Elastic Kubernetes Service](https://aws.amazon.com/eks/) powers Locobuzz's containerized architecture, while [Amazon OpenSearch Service](https://aws.amazon.com/opensearch-service/) enables near-real-time sentiment and intent analysis across digital channels.
...
[Amazon Bedrock](https://aws.amazon.com/bedrock/amazon-models/titan/) plays a central role, with Locobuzz relying on the solution to integrate foundation models like [Amazon Nova](https://aws.amazon.com/ai/generative-ai/nova/speech/) and Anthropic Claude Sonnet. Each model is chosen based on the task, allowing the team to balance accuracy, speed, and cost.
...
Startups like Locobuzz are able to access the latest AI models and tools through [AWS Activate](https://aws.amazon.com/activate/activate-landing/), helping them experiment, iterate, and launch solutions. The program also provides [AWS Credits](https://aws.amazon.com/startups/credits) which can be used for more than 200 AWS services as well as technical support from cloud engineers. More than 80% of AI/ML unicorns reported by Pitchbook in October 2025 are building on AWS. By joining AWS Activate you can plan a similar path, accessing the scalable infrastructure, support, and AI services needed to grow your business.
