---
source_url: https://aws.amazon.com/startups/learn/bright-money-uses-ai-to-close-the-credit-gap
...
Bright Money runs its core systems on AWS, using services like [Amazon Elastic Compute Cloud](https://aws.amazon.com/ec2/) and [Elastic Load Balancing](https://aws.amazon.com/elasticloadbalancing/). This helped the team scale compute resources dynamically, meeting customer demand without overprovisioning or overspending.
...
The company's most recent innovation came with the launch of an AI assistant built using [Amazon Bedrock](https://aws.amazon.com/bedrock/guardrails/). Designed to power two-way conversations, the assistant helps users better understand their finances, stay engaged with the app, and choose the right credit paths forward.
...
More than 75% of the startups listed by the [2025 CB Insights AI 100](https://www.cbinsights.com/research/report/artificial-intelligence-top-startups-2025/) are building on AWS, and through AWS Activate hundreds of thousands more are accessing tools to grow and differentiate their businesses. [AWS Activate](https://aws.amazon.com/activate/activate-landing/) is designed for early stage organizations, equipping founders with technical support, personalized guidance, and AWS credits to turn ideas into reality. Apply today to start building with an initial US $1,000 in AWS credits, and discover how your startup can stand out in a competitive market.
